    ...
    <SiteLayout>
      <div className="mx-auto max-w-3xl px-4 py-12 lg:px-8">
        ...
        <div className="mt-6 space-y-6 text-[#475569]">
          ...
          <section><h2 className="text-lg font-bold text-[#0f172a]">6. Trocas e devoluções</h2><p className="mt-2">Você tem 30 dias para solicitar troca ou devolução de produtos não perecíveis, conforme o Código de Defesa do Consumidor.</p></section>
          <section><h2 className="text-lg font-bold text-[#0f172a]">7. Ambiente demonstrativo</h2><p className="mt-2">Esta é uma plataforma demonstrativa. Produtos, preços e pedidos são fictícios para fins de demonstração de produto.</p></section>
