    ...
    <SiteLayout>
      <div className="mx-auto max-w-3xl px-4 py-12 lg:px-8">
        ...
        <div className="mt-6 space-y-6 text-[#475569]">
          ...
          <section><h2 className="text-lg font-bold text-[#0f172a]">4. Pagamentos</h2><p className="mt-2">Nesta demonstração, as formas de pagamento exibidas (PIX, cartão) e condições (ex.: 5% no PIX, parcelamento simulado) são exemplos de experiência de checkout. Nenhuma transação financeira real é processada.</p></section>
          <section><h2 className="text-lg font-bold text-[#0f172a]">5. Entrega</h2><p className="mt-2">Nesta demonstração, opções de entrega, prazos e valores (ex.: frete grátis acima de determinado valor) são simulações. Não há logística, estoque ou entregas reais.</p></section>
